 ...
 *
 */
public class SSSAExperimentRunner 
{
	private static final String DATA_FOLDER = "data/exp";
	private static final String ACTIONS_FILE = "etc/roman2020/sssa/stimulation_actions.xml";
	private static final String[] PROFILES = new String[] {
			"etc/roman2020/sssa/profile1.xml",
			"etc/roman2020/sssa/profile2.xml",
			"etc/roman2020/sssa/profile3.xml",
			"etc/roman2020/sssa/profile4.xml",
			"etc/roman2020/sssa/profile5.xml",
			"etc/roman2020/sssa/profile6.xml",
			"etc/roman2020/sssa/profile7.xml",
			"etc/roman2020/sssa/profile8.xml",
	};
	
	/**
	 * 
	 */
	protected SSSAExperimentRunner() {}
			...
			try (BufferedWriter writer =  new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file), "UTF-8")))
			{
				...
				for (String profileFile : PROFILES) 
				{
			        ...
			        OWLSirModel kb = new OWLSirModel(
			        		"etc/ontology/sir_stimulation_v1.1.owl",
			        		"etc/ontology/sir_stimulations_v1.1.rules");
		    		...
		    		List<Resource> list = sParser.getResources();
		    		for (Resource r : list) 
		    		{
